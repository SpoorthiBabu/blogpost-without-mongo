...
const obj = {
    toPrint: homeStartingContent,
    posts: posts
};
//here homeStartingContent is defined in this page and we are using that in .ejs file by assigning it to 
//toPrint and posting it there to be able to use it there
...
//the page that we have to render has to be in the format something.ejs and it should be under views which is 
//in the same heirarchical level and app.js
// app.get("/", function(req,res){
